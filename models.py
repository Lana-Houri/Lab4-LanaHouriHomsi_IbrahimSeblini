...
class Instructor(Person):
    ...
    def assign_course(self, course: str):
        '''
        Functionality: this method assign the instructor to a course.

        Parameter: only takes one parameter which is course of type string

        Return Value: it returns a confirmation message that the instructor was assigned to a course.
        '''
        ...
        "courses": [
            {
               ...
               "enrolled_students": [
                     {"id": s.student_id, "name": s.name} for s in c.enrolled_students
                ],
            }
